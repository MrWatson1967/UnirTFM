...
class TicproEstado(rx.State):
    ...
    def generar_diagrama(self):
        ...
        self.datos_ventas = obtener_ticket_promedio(self.opcion_seleccionada, self.fecha_inicial, self.fecha_final)

        data = pd.DataFrame(self.datos_ventas)
        data = data.sort_values("TicketPromedio", ascending=False)  # orden descendente        
        ...
        sns.barplot(data=data, x="TicketPromedio", y="Descripcion", palette="crest")
